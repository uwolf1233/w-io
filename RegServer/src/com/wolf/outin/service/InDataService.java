 ...
 *
 */
public class InDataService extends DefaultHandler {
...
//        }
    	if (nextIsString  && StringUtils.isNotEmpty(lastindex) && StringUtils.isNumeric(lastindex) && !lastindexjl.equals(lastindex)) {
            int idx = Integer.parseInt(lastindex);
            lastContents = new XSSFRichTextString(sst.getEntryAt(idx)).toString();
            lastindexjl = lastindex;
        }
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("**********************************************");
            //ExcelReaderUtil.readExcel(rowReader, "E:/其他开发/文件上传测试/41390267b3fc4e0bb99b3bb5261bc86f.xlsx");
            ExcelReaderUtil.readExcel(rowReader, "E:/其他开发/文件上传测试/123.xlsx");
        } catch (Exception e) {
            e.printStackTrace();
        }
