...
public class Server1Controller {
	...
	@MethodMapping(path="/downJdk",interfacetype="h")
	public void downJdk(ReqResBean rrb,Map<String,String> sessionMap){
		rrb.outFile("E:/jdk/jdk-7u79-linux-x64.tar.gz");
	}
	
	@MethodMapping(path="/opentest",interfacetype="h")
	public String opentest(ReqResBean rrb,Map<String,String> sessionMap){
		return "/Test/Test";
	}
